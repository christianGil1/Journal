                ...
                <div className="grid gap-8 md:grid-cols-3">
                    <div className="bg-white p-6 shadow-lg rounded-lg flex flex-col items-center">
                        ...
                        <p className="text-gray-600 mt-2 mb-4">
                            A comprehensive inventory management system designed to streamline tracking and optimize supply chain 
                            operations.
                        </p>
                        <button className="border-2 border-gray-800 text-gray-800 py-2 px-4 rounded hover:bg-gray-800 hover:text-white">
                        View Project
                    ...
                    <div className="bg-white p-6 shadow-lg rounded-lg flex flex-col items-center">
                        ...
                        <p className="text-gray-600 mt-2 mb-4">
                            A user-friendly booking system designed to simplify the process of booking and managing cruiseship 
                            reservations.
                        </p>
                        <button className="border-2 border-gray-800 text-gray-800 py-2 px-4 rounded hover:bg-gray-800 hover:text-white">
                        View Project
                    ...
                    <div className="bg-white p-6 shadow-lg rounded-lg flex flex-col items-center">
                        ...
                        <p className="text-gray-600 mt-2 mb-4">
                            The Xavier University - Night School Program Website was developed using the content management system of 
                            WordPress.
                        </p>
                        <button className="border-2 border-gray-800 text-gray-800 py-2 px-4 rounded hover:bg-gray-800 hover:text-white">
                        View Project
